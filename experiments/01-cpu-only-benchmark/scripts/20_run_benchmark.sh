...
run_step "sanity tests (experiment)" python3 -m pytest experiments/01-cpu-only-benchmark/scripts/test_sweep.py -q --tb=short
...
run_step "timeseries plots" python3 experiments/01-cpu-only-benchmark/scripts/08_plot_timeseries.py
