...
CFG=${1:-experiments/03-homogeneous-h100-benchmark/configs/benchmark-overnight.yaml}
INVENTORY=${2:-experiments/03-homogeneous-h100-benchmark/configs/cluster-nodes.yaml}
...
if [[ -f experiments/03-homogeneous-h100-benchmark/.venv/bin/activate ]]; then
  # shellcheck disable=SC1091
  source experiments/03-homogeneous-h100-benchmark/.venv/bin/activate
...
export GENERATED_CATALOG=${GENERATED_CATALOG:-"$ROOT/experiments/03-homogeneous-h100-benchmark/generated/hardware.generated.yaml"}
...

{
  ...
  run_step "generate heterogeneous assets" bash experiments/03-homogeneous-h100-benchmark/scripts/00_generate_assets.sh "$INVENTORY"
  run_step "setup cluster" bash experiments/03-homogeneous-h100-benchmark/scripts/10_setup_cluster.sh "$CFG" "$INVENTORY"
  run_step "run benchmark pipeline" bash experiments/03-homogeneous-h100-benchmark/scripts/20_run_benchmark.sh "$CFG"
